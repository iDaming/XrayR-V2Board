...
### x86_64
```
bash <(curl -Ls https://cdn.jsdelivr.net/gh/iDaming/XrayR-V2Board/install.sh)
```
### ARM_64
```
bash <(curl -Ls https://cdn.jsdelivr.net/gh/iDaming/XrayR-V2Board/install-arm.sh)
```
...
[![Star History Chart](https://api.star-history.com/svg?repos=iDaming/XrayR-V2Board&type=Date)](https://star-history.com/#fanux/missuo/XrayR-V2Board)
